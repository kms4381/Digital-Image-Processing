...
double variance(uchar** img, int size_x, int size_y)
{
...
int main(int argc, char* argv[])
{
	...
	var = variance(img, imgSize.width, imgSize.height);
	printf("Variance of image is %lf \n", var);
	printf("Standard Deviation of image is %lf \n", sqrt(var));
